...
import { A as Inbox, F as GitBranch, S as MapPin, X as CircleCheck, Y as Circle, it as CalendarDays, j as House, m as Plus, p as Send, q as Clock, r as Wallet } from "../_libs/lucide-react.mjs";
import { n as AnimatePresence, t as motion } from "../_libs/framer-motion.mjs";
import { a as EmptyState, c as SectionHeader, d as statusTone, i as DashboardShell, l as StatCard, n as Card, o as Pill, s as PremiumCard, t as ActionBtn, u as inputCls } from "./DashboardShell-BQbJfDoA.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { a as objectType, i as enumType, o as stringType } from "../_libs/zod.mjs";
import { n as useForm, t as u } from "../_libs/@hookform/resolvers+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/care.employee-DqbdQDuY.js
...
function EmployeeDashboard() {
	...
	const identity = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		className: "text-[10px] text-white/38 truncate",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: mine.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
						...
						className: `block w-full rounded-xl border p-4 text-left transition-all duration-150 ${open === r.id ? "border-[#e07a5f]/35 bg-[#e07a5f]/[0.07]" : "border-white/[0.06] bg-white/[0.02] hover:border-white/10 hover:bg-white/[0.04]"}`,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							r.thread.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-2 flex items-center gap-1 text-[10px] text-[#e07a5f]/60",
								children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							className: "text-[11px] text-white/30 tabular-nums mt-1.5",
					...
					selected.thread.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: selected.thread.map((m) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: `rounded-xl px-4 py-3 ${isMe ? "bg-[#e07a5f]/[0.07] border border-[#e07a5f]/15" : "bg-white/[0.03] border border-white/[0.05]"}`,
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									className: "text-[13px] text-white/78 leading-relaxed",
									children: m.body
								})]
							}, m.id);
						})
...
function MyHousingTab() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, { title: t("mycare.housing.section") }), !h ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
			...
			icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(House, { className: "h-5 w-5 text-white/30" }),
			action: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-[11px] text-white/22 max-w-xs leading-relaxed",
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PremiumCard, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-teal-400/12 ring-1 ring-teal-400/20",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(House, { className: "h-5 w-5 text-teal-400" })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "h-3.5 w-3.5 text-teal-400/70" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "text-[17px] font-semibold text-white/92",
							children: h.district
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: `text-[11px] text-white/38 mt-0.5`,
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(HousingTile, {
							icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Wallet, { className: "h-4 w-4 text-[#e07a5f]/70" }),
							label: t("mycare.housing.rent"),
							children: [
								"$",
								h.rentUsd.toLocaleString(),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-white/32 text-[11px] font-normal",
									children: "/mo"
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HousingTile, {
							icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CalendarDays, { className: "h-4 w-4 text-teal-400/60" }),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HousingTile, {
							icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: `h-4 w-4 ${h.depositReturned ? "text-emerald-400" : "text-white/22"}` }),
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PremiumCard, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								className: "mt-1 text-[13px] font-semibold text-[#e07a5f]",
								children: stage
							})]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "h-2 rounded-full bg-white/[0.07] overflow-hidden",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
							className: "h-full rounded-full",
							style: { background: "linear-gradient(90deg, #e07a5f, #2bc0b4)" },
							initial: { width: 0 },
							animate: { width: `${pct}%` },
							transition: {
								duration: .8,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-3 text-[12px] text-white/45 leading-relaxed",
				...
				className: "relative",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute left-[22px] top-6 bottom-6 w-px bg-white/[0.07]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "space-y-2",
					children: STAGES.map((s, i) => {
						...
						const future = i > idx;
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: `relative flex items-center gap-4 rounded-xl border px-4 py-3.5 transition-all ${current ? "border-[#e07a5f]/30 bg-[#e07a5f]/[0.06]" : done ? "border-emerald-500/15 bg-emerald-500/[0.03]" : "border-white/[0.04] bg-transparent"}`,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: done ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-4.5 w-4.5 text-emerald-400" })
								}) : current ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "flex h-9 w-9 items-center justify-center rounded-full bg-[#e07a5f]/15 ring-1 ring-[#e07a5f]/30",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-2.5 w-2.5 rounded-full bg-[#e07a5f] animate-pulse" })
								}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "flex h-9 w-9 items-center justify-center rounded-full bg-white/[0.04]",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Circle, { className: "h-4 w-4 text-white/15" })
								})
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: `text-[13px] font-semibold ${current ? "text-white/92" : done ? "text-white/60" : "text-white/28"}`,
											children: [
												t("dash.phase"),
												" ",
												i + 1,
										...
										current && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center gap-1.5 text-[10px] text-[#e07a5f] font-semibold shrink-0",
											children: [
											...
											className: "text-[10px] text-emerald-400/65 shrink-0",
											children: t("dash.completed")
										}),
										future && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-[10px] text-white/18 shrink-0",
											children: "Upcoming"
										})
									]
								})
