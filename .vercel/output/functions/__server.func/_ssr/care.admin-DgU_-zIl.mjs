...
import { a as STAGES, c as useCareLang, l as useCarePortal, n as CARE_STATUSES, o as getCareStaff, s as getCompanyName, t as CARE_CATEGORIES } from "./i18n-OlzCbsxR.mjs";
import { A as Inbox, I as Funnel, R as FileChartColumnIncreasing, S as MapPin, X as CircleCheck, at as Building2, i as Users, j as House, m as Plus, p as Send } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/care.admin-DgU_-zIl.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			state.companies.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
				...
				icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Building2, { className: "h-5 w-5 text-white/30" })
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-teal-400/10 text-[11px] font-bold text-teal-400",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
									className: "py-3.5 pr-4 text-[11px] text-white/40 tabular-nums hidden sm:table-cell",
									children: [
										c.contractStart,
										" → ",
										c.contractEnd
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											className: "text-[13px] text-white/75 tabular-nums",
											children: [used, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												className: "text-white/28",
												children: ["/", c.seats]
											})]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "w-16 h-1 rounded-full bg-white/[0.07] overflow-hidden",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
									className: "py-3.5 text-[12px] text-white/40 hidden md:table-cell",
				...
				children: [employees.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", {
						...
						children: employees.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
							...
							className: `cursor-pointer transition-colors ${edit === e.uid ? "bg-[#e07a5f]/[0.07]" : "hover:bg-white/[0.025]"}`,
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#e07a5f]/15 text-[13px] font-bold text-[#e07a5f] ring-1 ring-[#e07a5f]/20",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
							...
							className: "rounded-xl border border-white/[0.07] p-4 space-y-3",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("legend", {
									className: "px-1.5 text-[10px] uppercase tracking-widest text-white/32 flex items-center gap-1.5",
									children: [
...
function RequestsTab() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-wrap items-center gap-2 rounded-xl border border-white/[0.06] bg-white/[0.02] px-4 py-3",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Funnel, { className: "h-3.5 w-3.5 text-white/25 shrink-0" }),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: list.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-[13px] font-semibold text-white/90 leading-snug",
								children: r.subject
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									children: getCompanyName(state.companies, r.companyId) || "Guest"
								})]
							})
						]
					}, r.id))
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-wrap items-start justify-between gap-3 mb-4 pb-4 border-b border-white/[0.06]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: getCompanyName(state.companies, selected.companyId) || "Guest"
							})
						] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										className: "text-[10px] text-white/28 tabular-nums",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			state.reports.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
				...
				icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileChartColumnIncreasing, { className: "h-5 w-5 text-white/30" })
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: state.reports.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PremiumCard, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "font-mono text-[10px] text-white/22",
									children: r.id
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "mt-1 text-[14px] font-semibold text-white/92",
									children: getCompanyName(state.companies, r.companyId)
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-[12px] text-white/38 mt-0.5",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-[13px] text-white/60 leading-relaxed border-t border-white/[0.06] pt-3",
							children: r.summary
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-3 flex items-center gap-1.5 text-[10px] text-white/28",
							children: [
