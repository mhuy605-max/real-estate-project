...
import { c as useCareLang, l as useCarePortal, n as CARE_STATUSES, s as getCompanyName } from "./i18n-9hM-ab_H.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/care.staff-CRjBQFtq.js
...
function StaffDashboard() {
	...
	const identity = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		className: "text-[10px] text-black/38 font-mono",
		children: ["@", me.uid]
	})] });
	const nav = [
		{
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center gap-1.5 text-[11px] text-black/38",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						className: "mt-3 flex items-center gap-2 rounded-lg border border-black/[0.05] bg-black/[0.02] px-3.5 py-2.5",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-black/[0.08] text-[10px] font-bold text-black/60",
								children: selected.guestName ? selected.guestName.charAt(0).toUpperCase() : (selected.employeeId ?? "?").charAt(0).toUpperCase()
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "min-w-0 flex-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-[12px] text-black/70 font-medium",
									...
									className: "text-[11px] text-black/35 ml-2",
							...
							selected.assignedStaffUid && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center gap-1 text-[10px] text-[#14a76c]/70",
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-[11px] font-semibold text-black/78",
								...
								className: "text-[13px] text-black/75 leading-relaxed",
								children: m.body
							})]
						}, m.id);
					})
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										className: "text-[10px] text-black/32 font-mono",
										children: e.uid
									})] })]
								})
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Building2, { className: "h-3 w-3 text-black/25" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								...
								children: e.housing ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex items-center gap-1 text-[12px] text-black/55",
										...
										className: "text-[11px] text-black/32",
										children: [
											"$",
