...
import { G as Construction, O as Landmark, T as Lock, at as Building2, i as Users, j as House, l as Star, lt as ArrowUpRight, n as X, o as TrendingUp, tt as ChevronDown, ut as ArrowRight, x as Menu } from "../_libs/lucide-react.mjs";
...
import { a as IMAGES, c as t, i as DropdownMenuTrigger, n as DropdownMenuContent, o as LANGUAGES, r as DropdownMenuItem, s as NAV_LINKS, t as DropdownMenu } from "./dropdown-menu-V68zPXx_.mjs";
import { i as SliderTrack, n as SliderRange, r as SliderThumb, t as Slider$1 } from "../_libs/radix-ui__react-slider.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DZi6xhop.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-20 grid lg:grid-cols-[1fr_280px] gap-8 items-start min-w-0",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-14 grid lg:grid-cols-[400px_1fr] gap-8 min-w-0",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "panel-dark rounded-2xl p-8 space-y-8 min-w-0",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "label-eyebrow text-[var(--gold)]",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
														className: "p-4 text-muted-foreground tabular-nums whitespace-nowrap",
														children: [
															s.appr,
															" / ",
															s.yld
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
														className: "p-4 tabular-nums font-semibold whitespace-nowrap",
														children: fmt(s.data.totalReturn)
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
														className: "p-4 tabular-nums text-[var(--emerald-brand)] font-medium whitespace-nowrap",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "lg:hidden mt-2 px-1 text-[10px] text-muted-foreground uppercase tracking-widest",
										children: "← Swipe to see full comparison"
									})
								]
							})
						]
